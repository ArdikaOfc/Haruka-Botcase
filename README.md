...
📁 **[settings.js](https://github.com/ArdikaOfc/Haruka-Botcase/blob/master/settings.js)**  
...
> Any change in [settings.js](https://github.com/ArdikaOfc/Haruka-Botcase/blob/master/settings.js) will be **auto-reloaded** without restarting the bot.
...
📁 **[haruka.js](https://github.com/ArdikaOfc/Haruka-Botcase/blob/master/haruka.js)**
...
📁 **[index.js](https://github.com/ArdikaOfc/Haruka-Botcase/blob/master/index.js)**
This file is responsible for:
- Initializing Baileys connection
- Handling WhatsApp events
- Loading [settings.js](https://github.com/ArdikaOfc/Haruka-Botcase/blob/master/settings.js)
- Dispatching messages to [haruka.js](https://github.com/ArdikaOfc/Haruka-Botcase/blob/master/naze.js)

⚠️ **Editing [index.js](https://github.com/ArdikaOfc/Haruka-Botcase/blob/master/index.js) is not recommended unless you fully understand the bot flow.**
